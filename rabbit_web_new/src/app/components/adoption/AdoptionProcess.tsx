...
export default function AdoptionProcess({ onJumpToCommunity }: { onJumpToCommunity?: () => void }) {
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-br from-orange-100 to-pink-100 rounded-2xl p-6">
        ...
        <Button
          className="bg-gradient-to-r from-red-500 to-rose-500 hover:from-purple-600 hover:to-pink-600 w-full"
          onClick={onJumpToCommunity}
        >
          查看待领养兔兔
        </Button>
      </div>
